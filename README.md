# React JS Landing Page Template with [chakra-ui](https://github.com/chakra-ui/chakra-ui) and Typescript
...
All components data can be easily modified to git use by changing the data.JSON file that contains all data.
